...
typedef union HMM_M2
{
    float Elements[2][2];
    HMM_V2 Columns[2];

#ifdef __cplusplus
    inline HMM_V2 &operator[](const int &Index)
    {
...
typedef union HMM_M3
{
    float Elements[3][3];
    HMM_V3 Columns[3];

#ifdef __cplusplus
    inline HMM_V3 &operator[](const int &Index)
    {
        return Columns[Index];
    }
#endif
...
typedef union HMM_M4
{
    float Elements[4][4];
    HMM_V4 Columns[4];

#ifdef __cplusplus
    inline HMM_V4 &operator[](const int &Index)
    {
        return Columns[Index];
    }
#endif
...
COVERAGE(HMM_V2, 1)
static inline HMM_V2 HMM_V2(float X, float Y)
{
...
COVERAGE(HMM_V3, 1)
static inline HMM_V3 HMM_V3(float X, float Y, float Z)
{
...
COVERAGE(HMM_V4, 1)
static inline HMM_V4 HMM_V4(float X, float Y, float Z, float W)
{
...
COVERAGE(HMM_V4V, 1)
static inline HMM_V4 HMM_V4V(HMM_V3 Vector, float W)
{
...
static inline HMM_V2 HMM_AddV2(HMM_V2 Left, HMM_V2 Right)
{
...
static inline HMM_V3 HMM_AddV3(HMM_V3 Left, HMM_V3 Right)
{
...
static inline HMM_V4 HMM_AddV4(HMM_V4 Left, HMM_V4 Right)
{
...
static inline HMM_V2 HMM_SubV2(HMM_V2 Left, HMM_V2 Right)
{
...
static inline HMM_V3 HMM_SubV3(HMM_V3 Left, HMM_V3 Right)
{
...
static inline HMM_V4 HMM_SubV4(HMM_V4 Left, HMM_V4 Right)
{
...
static inline HMM_V2 HMM_MulV2(HMM_V2 Left, HMM_V2 Right)
{
...
static inline HMM_V2 HMM_MulV2F(HMM_V2 Left, float Right)
{
...
static inline HMM_V3 HMM_MulV3(HMM_V3 Left, HMM_V3 Right)
{
...
static inline HMM_V3 HMM_MulV3F(HMM_V3 Left, float Right)
{
...
static inline HMM_V4 HMM_MulV4(HMM_V4 Left, HMM_V4 Right)
{
...
static inline HMM_V4 HMM_MulV4F(HMM_V4 Left, float Right)
{
...
static inline HMM_V2 HMM_DivV2(HMM_V2 Left, HMM_V2 Right)
{
...
static inline HMM_V2 HMM_DivV2F(HMM_V2 Left, float Right)
{
...
static inline HMM_V3 HMM_DivV3(HMM_V3 Left, HMM_V3 Right)
{
...
static inline HMM_V3 HMM_DivV3F(HMM_V3 Left, float Right)
{
...
static inline HMM_V4 HMM_DivV4(HMM_V4 Left, HMM_V4 Right)
{
...
static inline HMM_V4 HMM_DivV4F(HMM_V4 Left, float Right)
{
...
COVERAGE(HMM_EqV2, 1)
static inline HMM_Bool HMM_EqV2(HMM_V2 Left, HMM_V2 Right)
{
...
COVERAGE(HMM_EqV3, 1)
static inline HMM_Bool HMM_EqV3(HMM_V3 Left, HMM_V3 Right)
{
...
COVERAGE(HMM_EqV4, 1)
static inline HMM_Bool HMM_EqV4(HMM_V4 Left, HMM_V4 Right)
{
...
static inline float HMM_DotV2(HMM_V2 Left, HMM_V2 Right)
{
...
static inline float HMM_DotV3(HMM_V3 Left, HMM_V3 Right)
{
...
static inline float HMM_DotV4(HMM_V4 Left, HMM_V4 Right)
{
...
static inline HMM_V3 HMM_Cross(HMM_V3 Left, HMM_V3 Right)
{
...
static inline float HMM_LenSqrV2(HMM_V2 A)
{
...
static inline float HMM_LenSqrV3(HMM_V3 A)
{
...
static inline float HMM_LenSqrV4(HMM_V4 A)
{
...
static inline float HMM_LenV2(HMM_V2 A)
{
...
static inline float HMM_LenV3(HMM_V3 A)
{
...
static inline float HMM_LenV4(HMM_V4 A)
{
...
static inline HMM_V2 HMM_NormV2(HMM_V2 A)
{
...
static inline HMM_V3 HMM_NormV3(HMM_V3 A)
{
...
static inline HMM_V4 HMM_NormV4(HMM_V4 A)
{
...
static inline HMM_V2 HMM_LerpV2(HMM_V2 A, float Time, HMM_V2 B) 
{
...
static inline HMM_V3 HMM_LerpV3(HMM_V3 A, float Time, HMM_V3 B) 
{
...
static inline HMM_V4 HMM_LerpV4(HMM_V4 A, float Time, HMM_V4 B) 
{
...
static inline HMM_V4 HMM_LinearCombineV4M4(HMM_V4 Left, HMM_M4 Right)
{
...
COVERAGE(HMM_M2, 1)
static inline HMM_M2 HMM_M2(void)
{
...
COVERAGE(HMM_M2D, 1)
static inline HMM_M2 HMM_M2D(float Diagonal)
{
...
COVERAGE(HMM_TransposeM4M2, 1)
static inline HMM_M2 HMM_TransposeM4M2(HMM_M2 Matrix)
{
    ASSERT_COVERED(HMM_TransposeM4M2);
    
    HMM_M2 Result = Matrix;
...
static inline HMM_M2 HMM_AddM2(HMM_M2 Left, HMM_M2 Right)
{
...
static inline HMM_M2 HMM_SubM2(HMM_M2 Left, HMM_M2 Right)
{
...
static inline HMM_V2 HMM_MulM2V2(HMM_M2 Matrix, HMM_V2 Vector)
{
...
static inline HMM_M2 HMM_MulM2(HMM_M2 Left, HMM_M2 Right)
{
...
static inline HMM_M2 HMM_MulM2F(HMM_M2 Matrix, float Scalar)
{
...
static inline HMM_M2 HMM_DivM2F(HMM_M2 Matrix, float Scalar)
{
...
static inline float HMM_DeterminantM2(HMM_M2 Matrix) 
{
...
static inline HMM_M2 HMM_InvGeneralM2(HMM_M2 Matrix) 
{
...
COVERAGE(HMM_M3, 1)
static inline HMM_M3 HMM_M3(void)
{
...
COVERAGE(HMM_M3D, 1)
static inline HMM_M3 HMM_M3D(float Diagonal)
{
...
COVERAGE(HMM_TransposeM4M3, 1)
static inline HMM_M3 HMM_TransposeM4M3(HMM_M3 Matrix)
{
    ASSERT_COVERED(HMM_TransposeM4M3);

    HMM_M3 Result = Matrix;
...
static inline HMM_M3 HMM_AddM3(HMM_M3 Left, HMM_M3 Right)
{
...
static inline HMM_M3 HMM_SubM3(HMM_M3 Left, HMM_M3 Right)
{
...
static inline HMM_V3 HMM_MulM3V3(HMM_M3 Matrix, HMM_V3 Vector)
{
...
static inline HMM_M3 HMM_MulM3(HMM_M3 Left, HMM_M3 Right)
{
...
static inline HMM_M3 HMM_MulM3F(HMM_M3 Matrix, float Scalar)
{
...
static inline HMM_M3 HMM_DivM3F(HMM_M3 Matrix, float Scalar)
{
...
static inline float HMM_DeterminantM3(HMM_M3 Matrix) 
{
...
static inline HMM_M3 HMM_InvGeneralM3(HMM_M3 Matrix) 
{
    ...
    return HMM_TransposeM4M3(Result);
}
...
COVERAGE(HMM_M4, 1)
static inline HMM_M4 HMM_M4(void)
{
...
COVERAGE(HMM_M4D, 1)
static inline HMM_M4 HMM_M4D(float Diagonal)
{
...
COVERAGE(HMM_TransposeM4M4, 1)
static inline HMM_M4 HMM_TransposeM4M4(HMM_M4 Matrix)
{
    ASSERT_COVERED(HMM_TransposeM4M4);

    HMM_M4 Result = Matrix;
#ifdef HANDMADE_MATH__USE_SSE
...
static inline HMM_M4 HMM_AddM4(HMM_M4 Left, HMM_M4 Right)
{
...
static inline HMM_M4 HMM_SubM4(HMM_M4 Left, HMM_M4 Right)
{
...
static inline HMM_M4 HMM_MulM4(HMM_M4 Left, HMM_M4 Right)
{
...
static inline HMM_M4 HMM_MulM4F(HMM_M4 Matrix, float Scalar)
{
...
static inline HMM_V4 HMM_MulM4V4(HMM_M4 Matrix, HMM_V4 Vector)
{
...
static inline HMM_M4 HMM_DivM4F(HMM_M4 Matrix, float Scalar)
{
...
static inline float HMM_DeterminantM4(HMM_M4 Matrix) 
{
    ASSERT_COVERED(HMM_DeterminantM4);

    HMM_V3 C01 = HMM_Cross(Matrix.Columns[0].XYZ, Matrix.Columns[1].XYZ);
    HMM_V3 C23 = HMM_Cross(Matrix.Columns[2].XYZ, Matrix.Columns[3].XYZ);
    HMM_V3 B10 = HMM_SubV3(HMM_MulV3F(Matrix.Columns[0].XYZ, Matrix.Columns[1].W), HMM_MulV3F(Matrix.Columns[1].XYZ, Matrix.Columns[0].W));
    HMM_V3 B32 = HMM_SubV3(HMM_MulV3F(Matrix.Columns[2].XYZ, Matrix.Columns[3].W), HMM_MulV3F(Matrix.Columns[3].XYZ, Matrix.Columns[2].W));
    
    return HMM_DotV3(C01, B32) + HMM_DotV3(C23, B10);
}

COVERAGE(HMM_InvGeneralM4, 1)
// Returns a general-purpose inverse of an HMM_M4. Note that special-purpose inverses of many transformations
// are available and will be more efficient.
static inline HMM_M4 HMM_InvGeneralM4(HMM_M4 Matrix) 
{
    ...
    return HMM_TransposeM4M4(Result);
}
...
static inline HMM_M4 HMM_Orthographic_RH_NO(float Left, float Right, float Bottom, float Top, float Near, float Far)
{
...
// Left, Right, Bottom, and Top specify the coordinates of their respective clipping planes.
// Near and Far specify the distances to the near and far clipping planes.
static inline HMM_M4 HMM_Orthographic_RH_ZO(float Left, float Right, float Bottom, float Top, float Near, float Far)
{
...
// Left, Right, Bottom, and Top specify the coordinates of their respective clipping planes.
// Near and Far specify the distances to the near and far clipping planes.
static inline HMM_M4 HMM_Orthographic_LH_NO(float Left, float Right, float Bottom, float Top, float Near, float Far)
{
    ASSERT_COVERED(HMM_Orthographic_LH_NO);

    HMM_M4 Result = HMM_Orthographic_RH_NO(Left, Right, Bottom, Top, Near, Far);
...
// Left, Right, Bottom, and Top specify the coordinates of their respective clipping planes.
// Near and Far specify the distances to the near and far clipping planes.
static inline HMM_M4 HMM_Orthographic_LH_ZO(float Left, float Right, float Bottom, float Top, float Near, float Far)
{
    ASSERT_COVERED(HMM_Orthographic_LH_ZO);

    HMM_M4 Result = HMM_Orthographic_RH_ZO(Left, Right, Bottom, Top, Near, Far);
    Result.Elements[2][2] = -Result.Elements[2][2];
    
    return Result;
}

COVERAGE(HMM_InvOrthographic_RH_NO, 1)
...
static inline HMM_M4 HMM_InvOrthographic_RH_NO(HMM_M4 OrthoMatrix)
{
    ASSERT_COVERED(HMM_InvOrthographic_RH_NO);
...
static inline HMM_M4 HMM_Perspective_RH_NO(HMM_AngleDeg(float FOV), float AspectRatio, float Near, float Far)
{
...
static inline HMM_M4 HMM_Perspective_RH_ZO(float FOV, float AspectRatio, float Near, float Far)
{
...
static inline HMM_M4 HMM_Perspective_LH_NO(float FOV, float AspectRatio, float Near, float Far)
{ 
    ASSERT_COVERED(HMM_Perspective_LH_NO);

    HMM_M4 Result = HMM_Perspective_RH_NO(HMM_AngleDeg(FOV), AspectRatio, Near, Far);
    Result.Elements[2][2] = -Result.Elements[2][2];
...
static inline HMM_M4 HMM_Perspective_LH_ZO(float FOV, float AspectRatio, float Near, float Far)
{ 
    ASSERT_COVERED(HMM_Perspective_LH_ZO);

    HMM_M4 Result = HMM_Perspective_RH_ZO(FOV, AspectRatio, Near, Far);
    Result.Elements[2][2] = -Result.Elements[2][2];
    Result.Elements[2][3] = -Result.Elements[2][3];
...
static inline HMM_M4 HMM_InvPerspective_RH(HMM_M4 PerspectiveMatrix)
{
...
static inline HMM_M4 HMM_InvPerspective_LH(HMM_M4 PerspectiveMatrix)
{
...
static inline HMM_M4 HMM_Translate(HMM_V3 Translation)
{
    ASSERT_COVERED(HMM_Translate);

    HMM_M4 Result = HMM_M4D(1.0f);
...
static inline HMM_M4 HMM_InvTranslate(HMM_M4 TranslationMatrix)
{
    ASSERT_COVERED(HMM_InvTranslate);

    HMM_M4 Result = TranslationMatrix;
...
static inline HMM_M4 HMM_Rotate_RH(HMM_AngleDeg(float Angle), HMM_V3 Axis)
{
...
static inline HMM_M4 HMM_Rotate_LH(float Angle, HMM_V3 Axis)
{
    ASSERT_COVERED(HMM_Rotate_LH);
    /* NOTE(lcf): Matrix will be inverse/transpose of RH. */
    return HMM_Rotate_RH(HMM_AngleDeg(-Angle), Axis);
}

COVERAGE(HMM_InvRotate_RH, 1)
static inline HMM_M4 HMM_InvRotate_RH(HMM_M4 RotationMatrix)
{
    ASSERT_COVERED(HMM_InvRotate_RH);
    return HMM_TransposeM4M4(RotationMatrix);
}

COVERAGE(HMM_Scale, 1)
static inline HMM_M4 HMM_Scale(HMM_V3 Scale)
{
...
static inline HMM_M4 HMM_InvScale(HMM_M4 ScaleMatrix) 
{
    ASSERT_COVERED(HMM_InvScale);

    HMM_M4 Result = ScaleMatrix;
...
static inline HMM_M4 _HMM_LookAt_RH(HMM_V3 F,  HMM_V3 S, HMM_V3 U,  HMM_V3 Eye)
{
    HMM_M4 Result;
...
static inline HMM_M4 HMM_LookAt_RH(HMM_V3 Eye, HMM_V3 Center, HMM_V3 Up)
{
    ASSERT_COVERED(HMM_LookAt_RH);

    HMM_V3 F = HMM_NormV3(HMM_SubV3(Center, Eye));
    HMM_V3 S = HMM_NormV3(HMM_Cross(F, Up));
    HMM_V3 U = HMM_Cross(S, F);

    return _HMM_LookAt_RH(F, S, U, Eye);
}

COVERAGE(HMM_LookAt_LH, 1)
static inline HMM_M4 HMM_LookAt_LH(HMM_V3 Eye, HMM_V3 Center, HMM_V3 Up)
{
    ASSERT_COVERED(HMM_LookAt_LH);

    HMM_V3 F = HMM_NormV3(HMM_SubV3(Eye, Center));
    HMM_V3 S = HMM_NormV3(HMM_Cross(F, Up));
    HMM_V3 U = HMM_Cross(S, F);
...
COVERAGE(HMM_InvLookAt_RH, 1)
static inline HMM_M4 HMM_InvLookAt_RH(HMM_M4 Matrix)
{
    ASSERT_COVERED(HMM_InvLookAt_RH);
    HMM_M4 Result;
    ...
    Rotation = HMM_TransposeM4M3(Rotation);
...
COVERAGE(HMM_QV4, 1)
static inline HMM_Quat HMM_QV4(HMM_V4 Vector)
{
...
static inline HMM_Quat HMM_NormQ(HMM_Quat Quat)
{
    ...
    HMM_V4 Vec = {Quat.X, Quat.Y, Quat.Z, Quat.W};
    Vec = HMM_NormV4(Vec);
...
static inline HMM_M4 HMM_QToM4(HMM_Quat Left)
{
...
static inline HMM_Quat HMM_M4ToQ_RH(HMM_M4 M)
{
    float T;
    HMM_Quat Q;
...
static inline HMM_Quat HMM_M4ToQ_LH(HMM_M4 M)
{
    float T;
    HMM_Quat Q;
...
static inline HMM_Quat HMM_QFromAxisAngle_RH(HMM_V3 Axis, float AngleOfRotation)
{
    ASSERT_COVERED(HMM_QFromAxisAngle_RH);

    HMM_Quat Result;

    HMM_V3 AxisNormalized = HMM_NormV3(Axis);
...
static inline HMM_Quat HMM_QFromAxisAngle_LH(HMM_V3 Axis, float AngleOfRotation)
{
...
static inline float HMM_Len(HMM_V2 A)
{
...
static inline float HMM_Len(HMM_V3 A)
{
...
static inline float HMM_Len(HMM_V4 A)
{
...
static inline float HMM_LenSqr(HMM_V2 A)
{
...
static inline float HMM_LenSqr(HMM_V3 A)
{
...
static inline float HMM_LenSqr(HMM_V4 A)
{
...
static inline HMM_V2 HMM_Norm(HMM_V2 A)
{
...
static inline HMM_V3 HMM_Norm(HMM_V3 A)
{
...
static inline HMM_V4 HMM_Norm(HMM_V4 A)
{
...
static inline float HMM_Dot(HMM_V2 Left, HMM_V2 VecTwo)
{
...
static inline float HMM_Dot(HMM_V3 Left, HMM_V3 VecTwo)
{
...
static inline float HMM_Dot(HMM_V4 Left, HMM_V4 VecTwo)
{
...
static inline HMM_V2 HMM_Lerp(HMM_V2 Left, float Time, HMM_V2 Right) 
{
...
static inline HMM_V3 HMM_Lerp(HMM_V3 Left, float Time, HMM_V3 Right) 
{
...
static inline HMM_V4 HMM_Lerp(HMM_V4 Left, float Time, HMM_V4 Right) 
{
    ASSERT_COVERED(HMM_LerpV4CPP);
    return HMM_LerpV4(Left, Time, Right);
}

COVERAGE(HMM_TransposeM4M2CPP, 1)
static inline HMM_M2 HMM_TransposeM4(HMM_M2 Matrix)
{
    ASSERT_COVERED(HMM_TransposeM4M2CPP);
    return HMM_TransposeM4M2(Matrix);
}

COVERAGE(HMM_TransposeM4M3CPP, 1)
static inline HMM_M3 HMM_TransposeM4(HMM_M3 Matrix)
{
    ASSERT_COVERED(HMM_TransposeM4M3CPP);
    return HMM_TransposeM4M3(Matrix);
}

COVERAGE(HMM_TransposeM4M4CPP, 1)
static inline HMM_M4 HMM_TransposeM4(HMM_M4 Matrix)
{
    ASSERT_COVERED(HMM_TransposeM4M4CPP);
    return HMM_TransposeM4M4(Matrix);
}

COVERAGE(HMM_DeterminantM2CPP, 1)
static inline float HMM_Determinant(HMM_M2 Matrix)
{
...
static inline float HMM_Determinant(HMM_M3 Matrix)
{
...
static inline float HMM_Determinant(HMM_M4 Matrix)
{
...
static inline HMM_M2 HMM_InvGeneral(HMM_M2 Matrix)
{
...
static inline HMM_M3 HMM_InvGeneral(HMM_M3 Matrix)
{
...
static inline HMM_M4 HMM_InvGeneral(HMM_M4 Matrix)
{
...
static inline HMM_V2 HMM_Add(HMM_V2 Left, HMM_V2 Right)
{
...
static inline HMM_V3 HMM_Add(HMM_V3 Left, HMM_V3 Right)
{
...
static inline HMM_V4 HMM_Add(HMM_V4 Left, HMM_V4 Right)
{
...
static inline HMM_M2 HMM_Add(HMM_M2 Left, HMM_M2 Right)
{
...
static inline HMM_M3 HMM_Add(HMM_M3 Left, HMM_M3 Right)
{
...
static inline HMM_M4 HMM_Add(HMM_M4 Left, HMM_M4 Right)
{
...
static inline HMM_V2 HMM_Sub(HMM_V2 Left, HMM_V2 Right)
{
...
static inline HMM_V3 HMM_Sub(HMM_V3 Left, HMM_V3 Right)
{
...
static inline HMM_V4 HMM_Sub(HMM_V4 Left, HMM_V4 Right)
{
...
static inline HMM_M2 HMM_Sub(HMM_M2 Left, HMM_M2 Right)
{
...
static inline HMM_M3 HMM_Sub(HMM_M3 Left, HMM_M3 Right)
{
...
static inline HMM_M4 HMM_Sub(HMM_M4 Left, HMM_M4 Right)
{
...
static inline HMM_V2 HMM_Mul(HMM_V2 Left, HMM_V2 Right)
{
...
static inline HMM_V2 HMM_Mul(HMM_V2 Left, float Right)
{
...
static inline HMM_V3 HMM_Mul(HMM_V3 Left, HMM_V3 Right)
{
...
static inline HMM_V3 HMM_Mul(HMM_V3 Left, float Right)
{
...
static inline HMM_V4 HMM_Mul(HMM_V4 Left, HMM_V4 Right)
{
...
static inline HMM_V4 HMM_Mul(HMM_V4 Left, float Right)
{
...
static inline HMM_M2 HMM_Mul(HMM_M2 Left, HMM_M2 Right)
{
...
static inline HMM_M3 HMM_Mul(HMM_M3 Left, HMM_M3 Right)
{
...
static inline HMM_M4 HMM_Mul(HMM_M4 Left, HMM_M4 Right)
{
...
static inline HMM_M2 HMM_Mul(HMM_M2 Left, float Right)
{
...
static inline HMM_M3 HMM_Mul(HMM_M3 Left, float Right)
{
...
static inline HMM_M4 HMM_Mul(HMM_M4 Left, float Right)
{
...
static inline HMM_V2 HMM_Mul(HMM_M2 Matrix, HMM_V2 Vector)
{
...
static inline HMM_V3 HMM_Mul(HMM_M3 Matrix, HMM_V3 Vector)
{
...
static inline HMM_V4 HMM_Mul(HMM_M4 Matrix, HMM_V4 Vector)
{
...
static inline HMM_V2 HMM_Div(HMM_V2 Left, HMM_V2 Right)
{
...
static inline HMM_V2 HMM_Div(HMM_V2 Left, float Right)
{
...
static inline HMM_V3 HMM_Div(HMM_V3 Left, HMM_V3 Right)
{
...
static inline HMM_V3 HMM_Div(HMM_V3 Left, float Right)
{
...
static inline HMM_V4 HMM_Div(HMM_V4 Left, HMM_V4 Right)
{
...
static inline HMM_V4 HMM_Div(HMM_V4 Left, float Right)
{
...
static inline HMM_M2 HMM_Div(HMM_M2 Left, float Right)
{
...
static inline HMM_M3 HMM_Div(HMM_M3 Left, float Right)
{
...
static inline HMM_M4 HMM_Div(HMM_M4 Left, float Right)
{
...
static inline HMM_Bool HMM_Eq(HMM_V2 Left, HMM_V2 Right)
{
...
static inline HMM_Bool HMM_Eq(HMM_V3 Left, HMM_V3 Right)
{
...
static inline HMM_Bool HMM_Eq(HMM_V4 Left, HMM_V4 Right)
{
...
static inline HMM_V2 operator+(HMM_V2 Left, HMM_V2 Right)
{
...
static inline HMM_V3 operator+(HMM_V3 Left, HMM_V3 Right)
{
...
static inline HMM_V4 operator+(HMM_V4 Left, HMM_V4 Right)
{
...
static inline HMM_M2 operator+(HMM_M2 Left, HMM_M2 Right)
{
...
static inline HMM_M3 operator+(HMM_M3 Left, HMM_M3 Right)
{
...
static inline HMM_M4 operator+(HMM_M4 Left, HMM_M4 Right)
{
...
static inline HMM_V2 operator*(HMM_V2 Left, float Right)
{
...
static inline HMM_V3 operator*(HMM_V3 Left, float Right)
{
...
static inline HMM_V4 operator*(HMM_V4 Left, float Right)
{
...
static inline HMM_M2 operator*(HMM_M2 Left, float Right)
{
...
static inline HMM_M3 operator*(HMM_M3 Left, float Right)
{
...
static inline HMM_M4 operator*(HMM_M4 Left, float Right)
{
...
static inline HMM_V2 operator*(float Left, HMM_V2 Right)
{
...
static inline HMM_V3 operator*(float Left, HMM_V3 Right)
{
...
static inline HMM_V4 operator*(float Left, HMM_V4 Right)
{
...
static inline HMM_M2 operator*(float Left, HMM_M2 Right)
{
...
static inline HMM_M3 operator*(float Left, HMM_M3 Right)
{
...
static inline HMM_M4 operator*(float Left, HMM_M4 Right)
{
...
static inline HMM_V2 operator*(HMM_M2 Matrix, HMM_V2 Vector)
{
...
static inline HMM_V3 operator*(HMM_M3 Matrix, HMM_V3 Vector)
{
...
static inline HMM_V4 operator*(HMM_M4 Matrix, HMM_V4 Vector)
{
...
static inline HMM_Bool operator==(HMM_V2 Left, HMM_V2 Right)
{
...
static inline HMM_Bool operator==(HMM_V3 Left, HMM_V3 Right)
{
...
static inline HMM_Bool operator==(HMM_V4 Left, HMM_V4 Right)
{
...
static inline HMM_V2 operator-(HMM_V2 In)
{
...
static inline HMM_V3 operator-(HMM_V3 In)
{
...
static inline HMM_V4 operator-(HMM_V4 In)
{
...
#define HMM_TransposeM4(M) _Generic((M), \
        HMM_M2: HMM_TransposeM4M2, \
        HMM_M3: HMM_TransposeM4M3, \
        HMM_M4: HMM_TransposeM4M4  \
)(M)

#define HMM_Determinant(M) _Generic((M), \
        HMM_M2: HMM_DeterminantM2, \
        HMM_M3: HMM_DeterminantM3, \
        HMM_M4: HMM_DeterminantM4  \
)(M)

#define HMM_InvGeneral(M) _Generic((M), \
        HMM_M2: HMM_InvGeneralM2, \
        HMM_M3: HMM_InvGeneralM3, \
        HMM_M4: HMM_InvGeneralM4  \
)(M)
